...
public class ParlanceRunner {
	...
	private static String HOME_FOLDER = "C:\\Users\\User";
	...
	public static void runParlanceServer(int numGames, int moveTimeLimit, int retreatTimeLimit, int buildTimeLimit) throws IOException{
    	...
    	try {
    		if(parlanceProcess == null){
    			...
    			System.out.println("BasicGameManger.runParlanceServer() parlance exit value: " + parlanceProcess.exitValue());
    		}
		} catch (IllegalThreadStateException e) {
			System.out.println("BasicGameManger.runParlanceServer() PARLANCE SERVER STARTED");
		}
